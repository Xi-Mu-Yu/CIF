...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_band \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 2048\
...
# Classical denoise baselines for SNR comparison (same setup, different denoise_method)
...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_bandpass_notch \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 32\
  ...
  --denoise_bp_low 1 \
  --denoise_bp_high 40 \
  --denoise_line_freq 50 \
  --denoise_notch_bw 1 \
  --denoise_notch_harmonics 1 \
  --log_snr True \
  --snr_log_interval 1 \
  --denoise_method csp \
  --denoise_csp_keep_ratio 0.7 \
  --denoise_csp_reg_eps 1e-6 \
  --gpu 0




# python Trail_snr/analyze_cif_trial_snr_gain.py --datasets_root ../Medformer_train/dataset --datasets APAVA --split TEST --device cpu --t 1 --n 9 --a -0.8 --b -0.6
...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_wavelet_db4 \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 2048\
...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_median \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 2048\
...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_savgol \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 2048\
...
export CUDA_VISIBLE_DEVICES=4
 python \
  ...
  --is_training 1 \
  --root_path ../Medformer_train/dataset/APAVA/ \
  --model_id Text/APAVA-Indep-hmbitcn_fp1 \
  --model HMBiTCN \
  --data APAVA \
  --e_layers 6 \
  --batch_size 2048 \
