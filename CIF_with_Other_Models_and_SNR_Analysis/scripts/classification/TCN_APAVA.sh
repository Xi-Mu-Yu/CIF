...
# t_values=(1 -1)
# a_values=$(seq -1 0.25 1)
# b_values=$(seq -1 0.25 1)
# n_values=$(seq 5 15)
# learnab_values=("False" "True")
...
#           model_id="HMBiTCN/APAVA/APAVA-Indep_A${a}_B${b}_T${t}_N${n}_L${learnab}"
...
# bash scripts/classification/TCN_APAVA.sh
# sed -i 's/\r$//' scripts/classification/TCN_copy.sh
